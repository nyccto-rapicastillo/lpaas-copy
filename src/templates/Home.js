...
export default function Home(props) {
    ...
    return(
        <PageTemplate page="Home" mainBg="bg-unity-yellow" hero={HomeImg} returnBg="bg-unity-blue">
            <YellowSection>
            ...
            <Grid>
                <div class="usa-graphic-list__row grid-row grid-gap">
                    <GridSquare img={CircleImg1} altText={t('conceptsAlt')} heading={t('conceptsHeading')}>
                        {t('conceptsAndVocab')}
                    </GridSquare>
                    
                    <GridSquare img={CircleImg2} alt={t('obligationsAlt')} heading={t('obligationsHeading')}>
                        {t('obligations')}
                    </GridSquare>
                </div>

                <div class="usa-graphic-list__row grid-row grid-gap">
                    <GridSquare img={CircleImg3} alt={t('safeSpaceAlt')} heading={t('safeSpaceHeading')}>
                        {t('safeSpace')}
                    </GridSquare>
                    
                    <GridSquare img={CircleImg4} alt={t('checkSafetyAlt')} heading={t('checkSafetyHeading')}>
                        {t('checkSafety')}
                    </GridSquare>
                </div>
            </Grid>
