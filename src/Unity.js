        ...
        <Switch>
          <Route path="/" exact 
            render={props => (
              ...
              buttonLink="#" buttonText="Download Report"
          ...
          <Route path="/about" exact
            render={props => (
              <About pageLabel="About" mainBg="bg-unity-yellow" heroLink="/" heroBg={AboutImg}
